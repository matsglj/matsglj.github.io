        ...
        */
        ...
        settings.images.each(
            function(index){
                ...
                *
                */
                var html = '<div class="' + settings.cssClass + '" style="position:relative; opacity:0;"><div class="Caption_Background" style="background-color:' +
                ...
                $this.bind(
                    {
                        mouseenter: function(e) {
                            $cap.animate({ top: (-1 * h) }, { duration: settings.speed, queue: true });
                            $cap.animate({ opacity: 1 }, { duration: settings.speed, queue: true });
                        },
                        mouseleave: function(e) {
                            $cap.animate({ opacity: 0 }, { duration: settings.speed, queue: true });
                            $cap.animate({ top: (1 * h), opacity: 0 }, { duration: settings.speed, queue: true });
                        }
                    }
                );
            }
